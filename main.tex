...
\usepackage{wrapfig}
\usepackage{graphicx}
% allows compilation of subfiles.
\usepackage{subfiles}
% keep order of mama and subfiles packages
\usepackage{./mama}

% solves compatibility problems. In order to obtain faster speed in compilation try to remove it. 
\tikzexternaldisable 
